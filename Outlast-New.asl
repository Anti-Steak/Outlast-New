...
startup {
  ...
  var tB = (Func<string, string, string, bool, Tuple<string, string, string, bool>>) ((elmt1, elmt2, elmt3, elmt4) => { return Tuple.Create(elmt1, elmt2, elmt3, elmt4); });
     var sB = new List<Tuple<string, string, string, bool>>
     {
      ...
      tB("hospital", "Hospital_2ndFloor_RoomsCoorridor", "Hallway after jumpscare guy", false),
      ...
      tB("rec", "Courtyard1_Start", "Start of Rec Area", true),
      ...
      tB("vocation", "Building2_Start", "Start of Voc Block", true),
      tB("vocation", "Building2_Attic_Mid", "Before push object", false),
      tB("vocation", "Building2_Attic_Denis", "Varient chase", false),
      tB("vocation", "Building2_Floor3_1", "Room with a lot of tables", false),
      tB("vocation", "Building2_Floor3_2", "Meeting Eddie", true),
      tB("vocation", "Building2_Floor3_3", "Escape Eddie", false),
      tB("vocation", "Building2_Floor3_4", "Before push object 2nd time", false),
      tB("vocation", "Building2_Floor3_Elevator", "After elevator cutscene", false),
      tB("vocation", "Building2_Floor3_Post_Elevator", "Leave elevator", false),
      ...
      tB("vocation", "Building2_Garden", "Escaping Eddie", true),
      tB("vocation", "Building2_Floor1_1", "Find key", false),
      tB("vocation", "Building2_Floor1_2", "Enter gym", false),
      tB("vocation", "Building2_Floor1_3", "When I was a boy", false),
      tB("vocation", "Building2_Floor1_4", "Eddie behind you", false),
